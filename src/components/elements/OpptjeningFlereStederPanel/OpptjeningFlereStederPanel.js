...
export const OpptjeningFlereStederPanel = () => {
    ...
    return(
        <Ekspanderbartpanel tittel={detailsTitle(t('opptjening-flere-steder-title'))} border className="panelWrapper">
            <Tekstomrade className="opptjeningMaterTitle">Det er tre måter å spare spesifikt til pensjon:</Tekstomrade>
            <div className="opptjeningMate">
                <div role="img" className="">
                    <svg viewBox="0 0 26 43" fill="none" xmlns="http://www.w3.org/2000/svg" focusable="false" className="opptjeningMateImage">
                ...
                <span className="opptjeningMateText">Folketrygden (Staten sparer for deg)</span>
            </div>
            ...
            <div className="opptjeningMate">
                ...
                <span className="opptjeningMateText">Tjenestepensjon (Du og din arbeidsgiver sparer sammen)</span>
            </div>
            ...
            <div className="opptjeningMate">
                ...
                <span className="opptjeningMateText">Individuell sparing (Du sparer selv)</span>
            </div>
            <Tekstomrade>Alle får pensjon i folketrygden. Hvis du er usikker på om du har individuell sparing eller tjenestepensjon kan du for eksempel se hos banken din eller spørre nåværende eller tidligere arbeidsgivere.</Tekstomrade>
        </Ekspanderbartpanel>
    )
};
