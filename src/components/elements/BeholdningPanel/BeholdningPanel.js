    ...
    return(
        <Panel border>
            <div className="beholdningPanel">
                <svg width="4rem" viewBox="0 0 71 89" fill="none" xmlns="http://www.w3.org/2000/svg" focusable="false" role="presentation" className="illustration">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M28.0494 36C28.5511 30.9467 32.8147 27 38 27C43.1853 27 47.4489 30.9467 47.9506 36C47.9833 35.6711 48 35.3375 48 35C48 29.4772 43.5228 25 38 25C32.4772 25 28 29.4772 28 35C28 35.3375 28.0167 35.6711 28.0494 36Z" fill="#D87F0A"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M28.0494 11C28.5511 5.94668 32.8147 2 38 2C43.1853 2 47.4489 5.94668 47.9506 11C47.9833 10.6711 48 10.3375 48 10C48 4.47715 43.5228 0 38 0C32.4772 0 28 4.47715 28 10C28 10.3375 28.0167 10.6711 28.0494 11Z" fill="#D87F0A"/>
                </svg>
