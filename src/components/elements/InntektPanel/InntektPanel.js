  ...
  inntekter.forEach((inntekt, idx) => {
    details.push(
      detailRow({
        ...
        label: inntekt.year,
        amount:
          inntekt.pensjonsgivendeInntekt !== null
            ? formatAmount(inntekt.pensjonsgivendeInntekt)
            : null,
        explanationText: t(
...
const detailsTitle = (title) => {
  return (
    <div role="heading" aria-level="2" className="inntektDetailTitle">
      ...
      <div id="inntektTitle" className="title">
        {title}
      </div>
    </div>
  );
...
export const InntektPanel = (props) => {
  ...
  return (
    <EkspanderbartpanelBase
      tittel={detailsTitle(t("inntekt-pensjonsgivende-inntekter"))}
      border
    ...
    >
      <div data-testid="inntektContainer">
        <div className="inntektLinkContainer">
          <Lenke href="https://www.skatteetaten.no/person/skatt/skattemelding/skattemelding-for-person/">
            {t("opptjening-inntekt-link-to-skatteetaten")}
          </Lenke>
        </div>
          ...
          <table className="tabell">
            <thead>
              <tr className="tableRow">
                <th data-testid="income-header" className="column1">
                  {t("inntekt-aar")}
                </th>
                <th data-testid="income-header" className="column2">
                  {t("inntekt-inntekt")}
                </th>
              </tr>
            </thead>
        ...
        <button
          type="button"
          aria-label={t("inntekt-lukk-panel")}
