    ...
    return(
        <div role="heading" aria-level="2" className="inntektDetailTitle">
            <svg width="1.3rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="illustration">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.5 13H0.5C0.224 13 0 13.2372 0 13.5294V21.4706C0 21.7628 0.224 22 0.5 22H4.5C4.775 22 5 21.7628 5 21.4706V13.5294C5 13.2372 4.775 13 4.5 13Z" fill="#337C9B"/>
